...
class TestCommentAPI:
    def test_list_comments_by_lead(self, api_client, lead, user):
        comment = Comment.objects.create(lead=lead, author=user, content="Commentaire test")
    ...
    def test_update_comment_by_author(self, api_client, lead, user):
        api_client.force_authenticate(user=user)
        comment = Comment.objects.create(lead=lead, author=user, content="Ancien contenu")
    ...
    def test_update_comment_by_other_user(self, api_client, lead, user, other_user):
        comment = Comment.objects.create(lead=lead, author=user, content="Contenu initial")
